...
| `java-quality-17.yml` | Java 17 质量检查（可复用）：单元测试 + JaCoCo、P3C/PMD、SpotBugs+FindSecBugs、OWASP Dependency-Check。业务仓用 `schedule`（每日 main/dev）+ `workflow_dispatch` 调用，传入 `ref` |
